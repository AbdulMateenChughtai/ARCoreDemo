...
class Texture(
    render: SampleRender?,
    /* package-private */val target: Target,
    wrapMode: WrapMode
) : Closeable {
            ...
            try {
                ...
                bitmap =
                    convertBitmapToConfig(
                        BitmapFactory.decodeStream(assetFileName?.let { render.assets.open(it) }),
